Hier is de volledig bijgewerkte README.md die exact aansluit op versie 47.1 van het programma.
...
Open een RAW-foto en klik in het paneel Geschiedenis op "alles verwijderen".

Zet Witbalans op "Camera".

Zet de module Kleurkalibratie (Color Calibration) volledig UIT.

Zet gewenste modules zoals Lenscorrectie, Sigmoid en Lokaal contrast aan.

Exporteer dit als oppepper.xmp en plaats dit in dezelfde map als het script.
